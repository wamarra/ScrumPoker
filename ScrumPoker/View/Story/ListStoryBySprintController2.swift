...
protocol ListStoryToPresenter2: AnyObject {
    var storiesObserver: Observable<Int> { get }
    func setLoading(_ loading: Bool)
}

class ListStoryBySprintController2: UIViewController {
...
extension ListStoryBySprintController2: ListStoryToPresenter2 {
